    ...
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className="flex justify-center mb-6">
          <div className="bg-gray-100 text-gray-600 ytext-sm px-4 py-2 rounded-full flex items-center gap-2">
         ...
         <div className='text-center mb-28'>
            ...
            className='text-gray-500 mt-6 max-w-2xl mx-auto text-lg'>
              Role-based mock interviews with smart follow-ups, adaptive difficulty and real-time performance
              evaluation.
            </motion.p>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                ${index === 2 ? "rotate-[ -3deg]":""}`}>
                  ...
                  <div className='absolute -top-8 left-1/2 -transition-x-1/2 bg-white border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>{item.icon}</div>
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc:"Details strengths, weakness and improvement insights."
                  },
                  {
                    image:analyticsImg,
                    icon:<BsBarChart size={20} />,
                    title: "History & Analytic",
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc:"basic tone and voice analysics insights."
                  },
                  {
                    image:creditImg,
